    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 px-4 py-10 sm:py-14">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-[#0A66C2] rounded-2xl flex items-center justify-center mx-auto mb-3">
              ...
              <div
                ...
                className={`flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold transition-all duration-300 ${
                  step < currentStep
                    ...
                    : "border-2 border-dashed border-gray-300 dark:border-gray-600 text-gray-400 bg-transparent"
                }`}
              >
                {step < currentStep ? (
        ...
        {currentStep === 1 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl flex items-center justify-center">
                  <Download className="w-5 h-5 text-[#0A66C2]" />
                </div>
                <div>
                  <p className="text-xs font-medium text-[#0A66C2]">Step 1 of 4</p>
                  <h2 className="font-bold text-gray-900 dark:text-white">Download Extension</h2>
                </div>
              </div>

              {downloading ? (
                <div className="flex items-center gap-3 p-4 bg-[#0A66C2]/5 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                ...
                <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-950/40 border border-dashed border-green-200 dark:border-green-800 rounded-xl">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-[#0A66C2] hover:bg-[#004182] text-white font-semibold px-4 py-3 rounded-xl text-sm transition-colors"
                  >
          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 p-7">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <p className="text-xs font-medium text-[#0A66C2]">Step 2 of 4</p>
              ...
              <div className="space-y-4">
                {/* Unzip instruction */}
                <div className="flex items-start gap-3 p-3.5 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                  <div className="w-6 h-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-xs font-bold text-[#0A66C2]">1</span>
                  </div>
                ...
                <div className="flex items-start gap-3 p-3.5 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                  <div className="w-6 h-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-xs font-bold text-[#0A66C2]">2</span>
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <button
                  onClick={() => goToStep(3)}
                  className="w-full flex items-center justify-center gap-2 text-[#0A66C2] hover:bg-[#0A66C2]/5 font-semibold px-4 py-2.5 rounded-xl text-sm transition-colors border border-dashed border-gray-300 dark:border-gray-600"
                >
                  I&apos;ve opened it
            ...
            <div className="mt-3 text-center">
              <a
                ...
                className="inline-flex items-center gap-1 text-xs text-gray-400 hover:text-[#0A66C2] transition-colors"
              >
        ...
        {currentStep === 3 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl flex items-center justify-center">
                  <Puzzle className="w-5 h-5 text-[#0A66C2]" />
                </div>
                <div>
                  <p className="text-xs font-medium text-[#0A66C2]">Step 3 of 4</p>
              ...
              <div className="space-y-3">
                {/* Developer Mode */}
                <div className="flex items-start gap-3 p-3.5 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                  <div className="w-6 h-6 border-2 border-dashed border-amber-300 dark:border-amber-700 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                {/* Select folder */}
                <div className="flex items-start gap-3 p-3.5 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                  <div className="w-6 h-6 border-2 border-dashed border-green-300 dark:border-green-700 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                {/* Warning tip */}
                <div className="flex items-start gap-2 text-xs text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 border border-dashed border-amber-200 dark:border-amber-800 rounded-xl px-3 py-2.5">
        ...
        {currentStep === 4 && !showSuccess && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-green-300 dark:border-green-800 p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 border-2 border-dashed border-green-300 dark:border-green-700 rounded-xl flex items-center justify-center">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-green-50 dark:bg-green-950/40 border border-dashed border-green-200 dark:border-green-800 rounded-xl">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-2.5 text-xs text-gray-600 dark:text-gray-400">
                    <CheckCircle className="w-4 h-4 text-[#0A66C2] flex-shrink-0 mt-0.5" />
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#0A66C2] hover:bg-[#004182] text-white font-bold px-4 py-3 rounded-xl text-sm transition-colors"
                >
        ...
        {showSuccess && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 mx-4 max-w-sm w-full text-center shadow-2xl animate-in zoom-in-95 duration-300">
              ...
              <div className="w-16 h-16 border-2 border-dashed border-green-300 dark:border-green-700 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1 mb-6 p-3 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                <p><strong>Connect</strong> with people → auto-tracked</p>
                <p><strong>Message</strong> someone → auto-tracked</p>
                <p><strong>Replies</strong> from contacts → auto-detected</p>
              </div>

              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-2 w-full bg-[#0A66C2] hover:bg-[#004182] text-white font-bold px-5 py-3 rounded-xl text-sm transition-colors"
              >
                Open Dashboard
                <ArrowRight className="w-4 h-4" />
              </Link>
        ...
        {!showSuccess && (
          <div className="mt-8 text-center">
            <Link
              href="/dashboard"
              className="text-xs text-gray-400 hover:text-[#0A66C2] hover:underline transition-colors"
            >
